...
public class GroupEnter: MonoBehaviour
{
    ...
    private void Start()
    {
        roomList.Add(new RoomInfo("Group_111", "1인 테스트방", 0, 1, "이은빈"));
        roomList.Add(new RoomInfo("Group_222", "2인방", 0, 2, "김민주"));
        roomList.Add(new RoomInfo("Group_333", "3인방", 0, 3, "김민준"));
        roomList.Add(new RoomInfo("Group_444", "4인방", 0, 4, "이동섭"));
